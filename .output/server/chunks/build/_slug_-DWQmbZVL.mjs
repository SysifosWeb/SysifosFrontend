...
import { withAsyncContext, computed, ref, mergeProps, withCtx, createTextVNode, createVNode, toDisplayString, useSSRContext } from 'vue';
...
import { h as useRoute, j as useRuntimeConfig } from './server.mjs';
import { u as useFetch } from './fetch-Dv5Ad036.mjs';
import { a as useSeoMeta } from './v3-BDfpV2lD.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data: postResponse } = ([__temp, __restore] = withAsyncContext(() => useFetch(
      `${apiUrl}blog/${route.params.slug}`,
      "$JsFjWYUreE"
      /* nuxt-injected */
...
//# sourceMappingURL=_slug_-DWQmbZVL.mjs.map
