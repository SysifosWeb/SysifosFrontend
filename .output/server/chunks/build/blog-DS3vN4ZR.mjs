...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const allCategories = computed(() => {
      ...
      const totalCount = ((_a = props.posts) == null ? void 0 : _a.total) || (((_b = props.posts) == null ? void 0 : _b.data) ? props.posts.data.length : 0);
      return [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.props.posts && _ctx.props.posts.links && _ctx.props.posts.links.length > 3) {
        _push(`<div class="flex justify-center"><nav class="flex items-center space-x-1"><!--[-->`);
        ssrRenderList(_ctx.props.posts.links, (link, index) => {
          var _a2, _b2;
          _push(`<!--[-->`);
          if (link.url) {
...
//# sourceMappingURL=blog-DS3vN4ZR.mjs.map
