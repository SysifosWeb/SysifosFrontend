...
import { a as buildAssetsURL, C as publicAssetsURL, G as useRuntimeConfig, r as getResponseStatusText, q as getResponseStatus, k as encodePath, f as defineRenderHandler, o as getQuery, c as createError, s as getRouteRules, x as joinURL, F as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"format-detection","content":"telephone=no"},{"name":"theme-color","content":"#1e40af"},{"name":"author","content":"Sysifos Web"},{"property":"og:site_name","content":"Sysifos Web"},{"property":"og:locale","content":"es_CL"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/logo_min.ico"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1","htmlAttrs":{"lang":"es"},"titleTemplate":"%s | SysifosWeb"};
