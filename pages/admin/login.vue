    ...
    <div
        ...
        <div class="absolute top-4 right-4 sm:top-6 sm:right-6">
            <button @click="toggleDarkMode"
                class="p-2 rounded-full bg-white dark:bg-slate-800 shadow-md text-gray-300 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300 transform hover:scale-110"
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center">
            ...
            <p class="mt-2 text-sm text-gray-300 dark:text-gray-300 transition-colors duration-300">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-300 dark:text-gray-300" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
