...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.zoJuvPlB.mjs').then(interopDefault),
  ...
  "pages/nosotros.vue": () => import('./nosotros-styles.Byvcovcl.mjs').then(interopDefault),
  "components/nosotros/StorytellingBreak.vue": () => import('./StorytellingBreak-styles.KkNMimdk.mjs').then(interopDefault),
  "components/nosotros/EquipoSection.vue": () => import('./EquipoSection-styles.DbgVaLhY.mjs').then(interopDefault),
  ...
  "pages/servicios.vue": () => import('./servicios-styles.DZKTDzVe.mjs').then(interopDefault),
  "components/servicios/HeroSection.vue": () => import('./HeroSection-styles.xX9nCbo-.mjs').then(interopDefault),
  "components/servicios/ListSection.vue": () => import('./ListSection-styles.CHzmtv-h.mjs').then(interopDefault),
