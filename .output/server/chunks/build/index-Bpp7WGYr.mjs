...
import { t as defu, n as hasProtocol, x as withLeadingSlash, q as joinURL, i as parseURL, y as encodeParam, k as encodePath } from '../nitro/nitro.mjs';
...
const ipxRuntime$jQy8Vqm2LeRX1wQ6ure8xfQVM_457MtviFRpVXS8ybUiY = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  operationsGenerator,
  supportsAlias,
...
const imageOptions = {
  ...
  providers: {
    ["ipx"]: { provider: ipxRuntime$jQy8Vqm2LeRX1wQ6ure8xfQVM_457MtviFRpVXS8ybUiY, defaults: {} }
  }
};
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+image@1.11.0_db0@0.3.4_ioredis@5.10.1_magicast@0.5.2_srvx@0.11.15/node_modules/@nuxt/image/dist/runtime/components/NuxtImg.vue");
...
//# sourceMappingURL=index-Bpp7WGYr.mjs.map
