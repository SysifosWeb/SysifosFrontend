...
import { u as useSEO } from './useSEO-CvfdKuFb.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "relative bg-section-dark py-16 lg:py-20 overflow-hidden" }, _attrs))}><div class="absolute rounded-full pointer-events-none blur-[120px] w-[480px] h-[480px] bg-indigo-500 opacity-5 -top-20 -left-30"></div><div class="absolute rounded-full pointer-events-none blur-[120px] w-[360px] h-[360px] bg-sky-400 opacity-5 top-[40%] -right-24"></div><div class="relative z-10 w-[90%] max-w-[1340px] mx-auto flex flex-col gap-24"><div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center"><div class="flex flex-col gap-0"><p${ssrRenderAttrs(mergeProps({
        ...
        "data-delay": "300"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))}><span class="text-2xl font-extrabold tracking-tight text-white">2024</span><span class="w-8 h-px bg-white/10"></span><span class="text-[0.7rem] font-medium tracking-[0.15em] uppercase text-white/50">A\xF1o de fundaci\xF3n</span></div></div><div${ssrRenderAttrs(mergeProps({
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _directive_reveal = resolveDirective("reveal");
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "equipo-section relative bg-section-dark overflow-hidden" }, _attrs))} data-v-993a3423><div class="ambient-orb ambient-orb--cyan" data-v-993a3423></div><div class="section-container" data-v-993a3423><div class="equipo-header" data-v-993a3423><div class="equipo-header__left" data-v-993a3423><p${ssrRenderAttrs(mergeProps({
        class: "overline-label",
        "data-delay": "0"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-993a3423>El equipo</p><h2${ssrRenderAttrs(mergeProps({
        class: "equipo-headline",
        "data-delay": "100"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-993a3423> Las mentes<br data-v-993a3423><em data-v-993a3423>detr\xE1s del c\xF3digo.</em></h2></div><div class="equipo-header__right" data-v-993a3423><p${ssrRenderAttrs(mergeProps({
        class: "equipo-descriptor",
        "data-delay": "200"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-993a3423> Tres especialistas, un est\xE1ndar de ingenier\xEDa. Construimos software que escala, resiste y evoluciona con tu negocio. </p></div></div><div class="team-roster" data-v-993a3423><div${ssrRenderAttrs(mergeProps({
        class: "roster-card group",
        "data-delay": "0"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-993a3423><img${ssrRenderAttr("src", unref(diego))} alt="Diego Araya" class="roster-photo" loading="lazy" data-v-993a3423><div class="roster-overlay" data-v-993a3423></div><div class="roster-info" data-v-993a3423><div class="roster-role" data-v-993a3423>`);
      _push(ssrRenderComponent(unref(TerminalSquare), { class: "roster-role__icon" }, null, _parent));
      _push(`<span class="roster-role__text" data-v-993a3423>Full Stack Developer</span></div><h3 class="roster-name" data-v-993a3423>Diego Araya</h3><p class="roster-bio" data-v-993a3423> Especializado en estructurar y dise\xF1ar m\xF3dulos escalables para aplicaciones web integrales de alta demanda. </p></div><div class="roster-accent-line roster-accent-line--cyan" data-v-993a3423></div></div><div${ssrRenderAttrs(mergeProps({
        class: "roster-card group roster-card--offset",
        "data-delay": "150"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-993a3423><img${ssrRenderAttr("src", unref(karen))} alt="Karen Godoy" class="roster-photo" loading="lazy" data-v-993a3423><div class="roster-overlay" data-v-993a3423></div><div class="roster-info" data-v-993a3423><div class="roster-role" data-v-993a3423>`);
      _push(ssrRenderComponent(unref(Database), { class: "roster-role__icon roster-role__icon--purple" }, null, _parent));
      _push(`<span class="roster-role__text roster-role__text--purple" data-v-993a3423>DBA &amp; Frontend</span></div><h3 class="roster-name" data-v-993a3423>Karen Godoy</h3><p class="roster-bio" data-v-993a3423> Control estructural enfocado en optimizaci\xF3n de bases de datos relacionales con eficiencia visual ininterrumpida. </p></div><div class="roster-accent-line roster-accent-line--purple" data-v-993a3423></div></div><div${ssrRenderAttrs(mergeProps({
        class: "roster-card group",
        "data-delay": "300"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-993a3423><img${ssrRenderAttr("src", unref(osman))} alt="Osman Ahumada" class="roster-photo" loading="lazy" data-v-993a3423><div class="roster-overlay" data-v-993a3423></div><div class="roster-info" data-v-993a3423><div class="roster-role" data-v-993a3423>`);
      _push(ssrRenderComponent(unref(Smartphone), { class: "roster-role__icon" }, null, _parent));
      _push(`<span class="roster-role__text" data-v-993a3423>Web &amp; Mobile Dev</span></div><h3 class="roster-name" data-v-993a3423>Osman Ahumada</h3><p class="roster-bio" data-v-993a3423> Especialista arquitect\xF3nico en ecosistemas h\xEDbridos Flutter. Gesti\xF3n fluida en compilaci\xF3n cross-platform. </p></div><div class="roster-accent-line roster-accent-line--cyan" data-v-993a3423></div></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-993a3423"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _directive_reveal = resolveDirective("reveal");
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "metodologia-section relative overflow-hidden" }, _attrs))} data-v-7140d5d2><div class="ambient-orb ambient-orb--indigo" data-v-7140d5d2></div><div class="section-container" data-v-7140d5d2><div class="metodologia-header" data-v-7140d5d2><div data-v-7140d5d2><p${ssrRenderAttrs(mergeProps({
        class: "overline-label",
        "data-delay": "0"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-7140d5d2>C\xF3mo trabajamos</p><h2${ssrRenderAttrs(mergeProps({
        class: "metodologia-headline",
        "data-delay": "100"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-7140d5d2> Operativa<br data-v-7140d5d2><em data-v-7140d5d2>estandarizada.</em></h2></div><p${ssrRenderAttrs(mergeProps({
        class: "metodologia-descriptor",
        "data-delay": "200"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-7140d5d2> Ejecuci\xF3n eficiente mediante protocolos \xE1giles. Precisi\xF3n funcional, tiempos predecibles y c\xF3digo que sobrevive a la escala. </p></div><div class="metodologia-grid" data-v-7140d5d2><div class="process-col" data-v-7140d5d2><p class="col-label" data-v-7140d5d2>Protocolos de Desarrollo</p><div class="process-steps" data-v-7140d5d2><div${ssrRenderAttrs(mergeProps({
        class: "process-step",
        "data-delay": "0"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-7140d5d2><div class="step-connector" data-v-7140d5d2><span class="step-node step-node--cyan" data-v-7140d5d2></span><span class="step-line" data-v-7140d5d2></span></div><div class="step-body" data-v-7140d5d2><h4 class="step-title" data-v-7140d5d2>Scrum Framework</h4><p class="step-text" data-v-7140d5d2>Sprints de 2 semanas con m\xE9tricas de entrega incrementales y ventanas de feedback continuo.</p></div></div><div${ssrRenderAttrs(mergeProps({
        class: "process-step",
        "data-delay": "150"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-7140d5d2><div class="step-connector" data-v-7140d5d2><span class="step-node step-node--purple" data-v-7140d5d2></span><span class="step-line" data-v-7140d5d2></span></div><div class="step-body" data-v-7140d5d2><h4 class="step-title" data-v-7140d5d2>Sincronizaci\xF3n Continua</h4><p class="step-text" data-v-7140d5d2>Alineaci\xF3n estrat\xE9gica mediante stand-ups diarios, demostraciones de avance y comunicaci\xF3n transparente.</p></div></div><div${ssrRenderAttrs(mergeProps({
        class: "process-step process-step--last",
        "data-delay": "300"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-7140d5d2><div class="step-connector" data-v-7140d5d2><span class="step-node step-node--cyan" data-v-7140d5d2></span></div><div class="step-body" data-v-7140d5d2><h4 class="step-title" data-v-7140d5d2>QA &amp; Estabilidad</h4><p class="step-text" data-v-7140d5d2>Testing unitario, code reviews estrictos y clean-code para garantizar arquitecturas s\xF3lidas en producci\xF3n.</p></div></div></div></div><div class="stack-col" data-v-7140d5d2><p class="col-label" data-v-7140d5d2>Stack Tecnol\xF3gico</p><div class="stack-table" data-v-7140d5d2><div${ssrRenderAttrs(mergeProps({
        class: "stack-row",
        "data-delay": "0"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-7140d5d2><div class="stack-row__layer" data-v-7140d5d2><span class="stack-row__label" data-v-7140d5d2>Frontend</span><span class="stack-row__sublabel" data-v-7140d5d2>Interfaces de alto rendimiento</span></div><span class="stack-row__tech stack-row__tech--cyan" data-v-7140d5d2>Vue.js / Nuxt / React</span></div><div${ssrRenderAttrs(mergeProps({
        class: "stack-row",
        "data-delay": "100"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-7140d5d2><div class="stack-row__layer" data-v-7140d5d2><span class="stack-row__label" data-v-7140d5d2>Backend</span><span class="stack-row__sublabel" data-v-7140d5d2>L\xF3gica y bases de datos</span></div><span class="stack-row__tech stack-row__tech--purple" data-v-7140d5d2>Laravel / Node.js</span></div><div${ssrRenderAttrs(mergeProps({
        class: "stack-row",
        "data-delay": "200"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-7140d5d2><div class="stack-row__layer" data-v-7140d5d2><span class="stack-row__label" data-v-7140d5d2>Mobile</span><span class="stack-row__sublabel" data-v-7140d5d2>Desarrollo multiplataforma</span></div><span class="stack-row__tech stack-row__tech--cyan" data-v-7140d5d2>Flutter / React Native</span></div><p${ssrRenderAttrs(mergeProps({
        class: "stack-note",
        "data-delay": "300"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-7140d5d2> Seleccionamos la tecnolog\xEDa \xF3ptima para cada contexto. Sin dogma, con criterio. </p></div></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7140d5d2"]]);
const _sfc_main = {
  __name: "nosotros",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=nosotros-CJjFu7MB.mjs.map
