...
const styles = {
  ...
  "layouts/default.vue": () => import('./default-styles.Bxcbua_Z.mjs').then(interopDefault),
  "components/AppHeader.vue": () => import('./default-styles.Bxcbua_Z.mjs').then(interopDefault),
