...
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderAttr, ssrRenderList, ssrGetDirectiveProps, ssrRenderClass } from 'vue/server-renderer';
import { k as useRuntimeConfig, b as _export_sfc, _ as __nuxt_component_0$1 } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const { data: blogResponse } = useFetch(
      `${apiUrl}blog`,
      {
        key: "blog-index-list"
      },
...
//# sourceMappingURL=index-rTn99U6f.mjs.map
