...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const categories = computed(() => {
      ...
      if ((_a = categoriesResponse.value) == null ? void 0 : _a.data) {
    ...
    const mappedPosts = computed(() => {
      var _a;
      if (!((_a = postsResponse.value) == null ? void 0 : _a.data)) return [];
      return postsResponse.value.data.map((p) => {
        ...
        return {
          ...
          title: p.title,
          excerpt: p.excerpt,
          category: p.category || { name: "Sin categor\xEDa", slug: "uncategorized" },
          ...
          author: ((_a2 = p.user) == null ? void 0 : _a2.name) || "Sysifos Engineering",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (selectedCategory.value === "all" && !searchQuery.value && featuredPost.value) {
...
//# sourceMappingURL=index-Ss1rzMCf.mjs.map
