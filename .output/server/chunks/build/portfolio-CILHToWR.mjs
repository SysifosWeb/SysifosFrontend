...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    setMeta({
      title: "Portfolio de Proyectos | Desarrollo Web y Casos de \xC9xito",
      description: "Explora nuestros desarrollos: Ansar Automotriz, Maestranza Faremin, StahlForm y Carmotor's. Ingenier\xEDa de software aplicada a soluciones reales de negocio en Chile y el mundo.",
      keywords: "portafolio desarrollo web, casos de \xE9xito software, ejemplos desarrollo web chile, soluciones digitales empresas",
...
//# sourceMappingURL=portfolio-CILHToWR.mjs.map
