import { computed, ref, mergeProps, withCtx, createVNode, toDisplayString, openBlock, createBlock, resolveDirective, useSSRContext } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const { data: categoriesResponse } = useFetch(
      `${apiUrl}category`,
      "$rgqBraeMHp"
      /* nuxt-injected */
    );
...
//# sourceMappingURL=index-BGf1T6hp.mjs.map
