...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _directive_reveal = resolveDirective("reveal");
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "py-16 overflow-hidden relative bg-section-dark" }, _attrs))} data-v-af4b2a78><div class="absolute top-1/2 left-0 w-[300px] h-[300px] -translate-y-1/2 pointer-events-none" style="${ssrRenderStyle({ "background": "radial-gradient(circle, var(--purple) 0%, transparent 70%)", "opacity": "0.1" })}" aria-hidden="true" data-v-af4b2a78></div><div class="w-[88%] max-w-[1340px] mx-auto relative z-20" data-v-af4b2a78><div class="flex flex-col lg:flex-row items-center gap-12" data-v-af4b2a78><div class="w-full lg:w-[380px] shrink-0 mb-12 lg:mb-0" data-v-af4b2a78><p${ssrRenderAttrs(mergeProps({
        class: "section-eyebrow section-eyebrow--purple mb-4",
        "data-delay": "0"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-af4b2a78>Stack tecnol\xF3gico</p><div${ssrRenderAttrs(mergeProps({
        class: "flex flex-col leading-tight",
        "data-delay": "100"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-af4b2a78><span class="text-3xl lg:text-4xl font-bold" style="${ssrRenderStyle({ "color": "var(--text-main)", "letter-spacing": "-0.025em", "font-family": "'Inter', sans-serif" })}" data-v-af4b2a78>Tecnolog\xEDa de</span><span class="text-3xl lg:text-4xl font-bold" style="${ssrRenderStyle({ "color": "var(--accent)", "letter-spacing": "-0.025em", "font-family": "'Inter', sans-serif" })}" data-v-af4b2a78>vanguardia.</span><p class="mt-4 text-sm leading-relaxed max-w-[280px]" style="${ssrRenderStyle({ "color": "var(--text-secondary)" })}" data-v-af4b2a78>Construimos con las herramientas que usan las mejores empresas del mundo.</p></div></div><div${ssrRenderAttrs(mergeProps({
        ref_key: "carouselContainer",
        ref: carouselContainer,
        class: "relative flex-grow overflow-hidden py-32",
        "data-delay": "200"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-af4b2a78><div class="flex flex-nowrap w-max animate-slow-marquee hover:[animation-play-state:paused]" data-v-af4b2a78><!--[-->`);
      ssrRenderList(2, (set) => {
        _push(`<div class="flex flex-nowrap" data-v-af4b2a78><!--[-->`);
        ssrRenderList(technologies, (tech, index) => {
          _push(`<div class="tech-item relative shrink-0 flex flex-col items-center justify-center w-[160px] lg:w-[240px] transition-all duration-300"${ssrRenderAttr("aria-label", tech.fullName)} data-v-af4b2a78>`);
          ...
          _push(`<div class="tech-name absolute -bottom-12 left-1/2 -translate-x-1/2 text-[14px] font-bold text-accent opacity-0 transition-opacity tracking-[0.4em] font-mono text-center whitespace-nowrap uppercase" aria-hidden="true" data-v-af4b2a78>${ssrInterpolate(tech.name)}</div></div>`);
        });
        _push(`<!--]--></div>`);
      });
      _push(`<!--]--></div><div class="absolute inset-y-0 right-0 w-32 to-transparent z-10 pointer-events-none" style="${ssrRenderStyle({ "background": "linear-gradient(to left, var(--bg-dark), transparent)" })}" aria-hidden="true" data-v-af4b2a78></div></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-af4b2a78"]]);
const _sfc_main$2 = {
...
//# sourceMappingURL=index-CgD09KjJ.mjs.map
