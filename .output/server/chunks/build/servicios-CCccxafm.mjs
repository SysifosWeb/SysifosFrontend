  ...
  setup(__props) {
    const services = [
      ...
      },
      {
        ...
        ctaLink: "https://wa.me/56949109970?text=Hola,%20necesito%20una%20evaluaci\xF3n%20t\xE9cnica%20para%20Software%20a%20Medida."
      }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      const _directive_reveal = resolveDirective("reveal");
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "relative bg-section-dark py-8 lg:py-16 overflow-hidden" }, _attrs))} data-v-33d28e40><div class="section-container relative z-10" data-v-33d28e40><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8" data-v-33d28e40><!--[-->`);
      ssrRenderList(services, (item, index) => {
        ...
        }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-33d28e40><div class="absolute top-0 inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-accent/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" data-v-33d28e40></div><div class="flex justify-between items-start mb-6 relative z-10" data-v-33d28e40><div class="w-14 h-14 rounded-2xl bg-white/5 shadow-[0_0_20px_rgba(255,255,255,0.02)] flex items-center justify-center border border-white/10 text-accent group-hover:scale-110 group-hover:bg-accent/10 group-hover:border-accent/30 group-hover:shadow-[0_0_30px_rgba(56,189,248,0.15)] transition-all duration-500" data-v-33d28e40>`);
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(item.icon), { class: "w-7 h-7 drop-shadow-lg" }, null), _parent);
        _push(`</div><span class="text-[10px] font-extrabold tracking-widest text-accent uppercase bg-accent/10 px-3 py-1 rounded-full border border-accent/20" data-v-33d28e40>${ssrInterpolate(item.eyebrow)}</span></div><h3 class="text-2xl font-bold tracking-tight text-white mb-3 relative z-10" data-v-33d28e40>${ssrInterpolate(item.title)}</h3><p class="text-white/60 text-sm leading-relaxed mb-6 h-10 relative z-10" data-v-33d28e40>${ssrInterpolate(item.description)}</p><div class="relative w-full my-6 flex items-center z-10" data-v-33d28e40><div class="w-full border-t border-dashed border-white/10 group-hover:border-white/20 transition-colors duration-500" data-v-33d28e40></div></div><div class="flex-grow mb-8 relative z-10" data-v-33d28e40><p class="text-[11px] font-bold text-accent/60 uppercase tracking-widest mb-4" data-v-33d28e40>\xBFQu\xE9 incluye?</p><ul class="flex flex-col gap-3" data-v-33d28e40><!--[-->`);
        ssrRenderList(item.features, (feature) => {
          _push(`<li class="flex items-start gap-3 text-sm text-white/80 font-medium" data-v-33d28e40><div class="relative flex items-center justify-center mt-0.5" data-v-33d28e40><div class="absolute inset-0 bg-accent/20 rounded-full blur-[4px] group-hover:blur-[6px] transition-all" data-v-33d28e40></div><div class="relative w-5 h-5 rounded-full bg-gradient-to-br from-accent/20 to-transparent border border-accent/40 flex items-center justify-center shadow-inner" data-v-33d28e40>`);
          _push(ssrRenderComponent(unref(CheckCircle2), { class: "w-3 h-3 text-accent" }, null, _parent));
          _push(`</div></div><span class="leading-tight" data-v-33d28e40>${ssrInterpolate(feature)}</span></li>`);
        });
        _push(`<!--]--></ul></div><a${ssrRenderAttr("href", item.ctaLink)} target="_blank" class="w-full relative z-10 flex items-center justify-center gap-2 py-3.5 rounded-xl text-sm font-bold transition-all duration-300 bg-white/5 text-white hover:bg-accent hover:text-black border border-white/10 hover:border-accent" data-v-33d28e40>${ssrInterpolate(item.ctaText)} `);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-33d28e40"]]);
...
//# sourceMappingURL=servicios-CCccxafm.mjs.map
