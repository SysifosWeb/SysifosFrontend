import { resolveDirective, mergeProps, createVNode, resolveDynamicComponent, unref, withCtx, createTextVNode, openBlock, createBlock, ref, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs, ssrGetDirectiveProps, ssrRenderList, ssrRenderVNode, ssrInterpolate, ssrRenderClass, ssrRenderStyle, ssrRenderAttr } from 'vue/server-renderer';
...
import { _ as _sfc_main$8 } from './NuxtImg-Dvqf6ive.mjs';
import { u as useSEO } from './useSEO-CDdqZwTP.mjs';
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-a9a002c8"]]);
const _sfc_main$6 = {
  __name: "HomeProblems",
  __ssrInlineRender: true,
  setup(__props) {
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-da7d8d3c"]]);
const _sfc_main$5 = {
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-0cc5a304"]]);
const _sfc_main$4 = {
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-5364e36c"]]);
const _sfc_main$3 = {
  __name: "HomeTrust",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _directive_reveal = resolveDirective("reveal");
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "py-16 overflow-hidden relative bg-section-dark" }, _attrs))} data-v-8f6e9815><div class="absolute top-1/2 left-0 w-[300px] h-[300px] -translate-y-1/2 rounded-full pointer-events-none" style="${ssrRenderStyle({ "background": "var(--purple)", "opacity": "0.07", "filter": "blur(120px)" })}" aria-hidden="true" data-v-8f6e9815></div><div class="w-[88%] max-w-[1340px] mx-auto relative z-20" data-v-8f6e9815><div class="flex flex-col lg:flex-row items-center gap-12" data-v-8f6e9815><div class="w-full lg:w-[380px] shrink-0 mb-12 lg:mb-0" data-v-8f6e9815><p${ssrRenderAttrs(mergeProps({
        class: "section-eyebrow section-eyebrow--purple mb-4",
        "data-delay": "0"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-8f6e9815>Stack tecnol\xF3gico</p><div${ssrRenderAttrs(mergeProps({
        class: "flex flex-col leading-tight",
        "data-delay": "100"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-8f6e9815><span class="text-3xl lg:text-4xl font-bold" style="${ssrRenderStyle({ "color": "var(--text-main)", "letter-spacing": "-0.025em", "font-family": "'Inter', sans-serif" })}" data-v-8f6e9815>Tecnolog\xEDa de</span><span class="text-3xl lg:text-4xl font-bold" style="${ssrRenderStyle({ "color": "var(--accent)", "letter-spacing": "-0.025em", "font-family": "'Inter', sans-serif" })}" data-v-8f6e9815>vanguardia.</span><p class="mt-4 text-sm leading-relaxed max-w-[280px]" style="${ssrRenderStyle({ "color": "var(--text-secondary)" })}" data-v-8f6e9815>Construimos con las herramientas que usan las mejores empresas del mundo.</p></div></div><div${ssrRenderAttrs(mergeProps({
        ref_key: "carouselContainer",
        ref: carouselContainer,
        class: "relative flex-grow overflow-hidden py-32",
        "data-delay": "200"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-8f6e9815><div class="flex flex-nowrap w-max animate-slow-marquee hover:[animation-play-state:paused]" data-v-8f6e9815><!--[-->`);
      ssrRenderList(2, (set) => {
        _push(`<div class="flex flex-nowrap" data-v-8f6e9815><!--[-->`);
        ssrRenderList(technologies, (tech, index) => {
          _push(`<div class="tech-item relative shrink-0 flex flex-col items-center justify-center w-[160px] lg:w-[240px] transition-all duration-300"${ssrRenderAttr("aria-label", tech.fullName)} data-v-8f6e9815>`);
          ...
          _push(`<div class="tech-name absolute -bottom-12 left-1/2 -translate-x-1/2 text-[14px] font-bold text-accent opacity-0 transition-opacity tracking-[0.4em] font-mono text-center whitespace-nowrap uppercase" aria-hidden="true" data-v-8f6e9815>${ssrInterpolate(tech.name)}</div></div>`);
        });
        _push(`<!--]--></div>`);
      });
      _push(`<!--]--></div><div class="absolute inset-y-0 right-0 w-32 to-transparent z-10 pointer-events-none" style="${ssrRenderStyle({ "background": "linear-gradient(to left, var(--bg-dark), transparent)" })}" aria-hidden="true" data-v-8f6e9815></div></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-8f6e9815"]]);
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _directive_reveal = resolveDirective("reveal");
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "testimonials-section relative overflow-hidden bg-section-dark" }, _attrs))} data-v-bb29acb6><div class="ambient-orb" data-v-bb29acb6></div><div class="section-container" data-v-bb29acb6><div class="section-header" data-v-bb29acb6><div data-v-bb29acb6><p${ssrRenderAttrs(mergeProps({
        class: "overline-label",
        "data-delay": "0"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-bb29acb6>Clientes</p><h2${ssrRenderAttrs(mergeProps({
        class: "section-headline",
        "data-delay": "100"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-bb29acb6> Empresas que crecieron<br data-v-bb29acb6><em data-v-bb29acb6>con nuestra tecnolog\xEDa.</em></h2></div><div${ssrRenderAttrs(mergeProps({
        class: "proof-strip",
        "data-delay": "200"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-bb29acb6><div class="proof-stars" aria-label="Valoraci\xF3n: 5 estrellas" data-v-bb29acb6><!--[-->`);
      ssrRenderList(5, (s) => {
        _push(`<svg class="w-3.5 h-3.5" viewBox="0 0 20 20" fill="#F59E0B" aria-hidden="true" data-v-bb29acb6><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" data-v-bb29acb6></path></svg>`);
      });
      _push(`<!--]--></div><p class="proof-label" data-v-bb29acb6>5.0 \xB7 98% clientes satisfechos</p></div></div><div class="bento-grid" data-v-bb29acb6><article${ssrRenderAttrs(mergeProps({
        class: "bento-card bento-card--featured group",
        "data-delay": "0"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-bb29acb6><div class="card-accent-line card-accent-line--cyan" aria-hidden="true" data-v-bb29acb6></div><span class="quote-mark" aria-hidden="true" data-v-bb29acb6>\u201C</span><blockquote class="quote-text quote-text--lg" data-v-bb29acb6><p data-v-bb29acb6>${ssrInterpolate(testimonials[0].text)}</p></blockquote><div class="metric-block metric-block--featured" data-v-bb29acb6><span class="metric-number metric-number--cyan" data-v-bb29acb6>${ssrInterpolate(testimonials[0].metric)}</span><span class="metric-label" data-v-bb29acb6>${ssrInterpolate(testimonials[0].metricLabel)}</span></div><footer class="author-row" data-v-bb29acb6><div class="author-avatar" style="${ssrRenderStyle({ background: testimonials[0].avatarBg })}" aria-hidden="true" data-v-bb29acb6>${ssrInterpolate(testimonials[0].initials)}</div><cite data-v-bb29acb6><p class="author-name" data-v-bb29acb6>${ssrInterpolate(testimonials[0].name)}</p><p class="author-company" data-v-bb29acb6>${ssrInterpolate(testimonials[0].company)}</p></cite></footer></article><div class="bento-col-right" data-v-bb29acb6><article${ssrRenderAttrs(mergeProps({
        class: "bento-card group",
        "data-delay": "150"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-bb29acb6><div class="card-accent-line card-accent-line--purple" aria-hidden="true" data-v-bb29acb6></div><span class="quote-mark quote-mark--sm" aria-hidden="true" data-v-bb29acb6>\u201C</span><blockquote class="quote-text" data-v-bb29acb6><p data-v-bb29acb6>${ssrInterpolate(testimonials[1].text)}</p></blockquote><div class="metric-block" data-v-bb29acb6><span class="metric-number metric-number--purple" data-v-bb29acb6>${ssrInterpolate(testimonials[1].metric)}</span><span class="metric-label" data-v-bb29acb6>${ssrInterpolate(testimonials[1].metricLabel)}</span></div><footer class="author-row" data-v-bb29acb6><div class="author-avatar" style="${ssrRenderStyle({ background: testimonials[1].avatarBg })}" aria-hidden="true" data-v-bb29acb6>${ssrInterpolate(testimonials[1].initials)}</div><cite data-v-bb29acb6><p class="author-name" data-v-bb29acb6>${ssrInterpolate(testimonials[1].name)}</p><p class="author-company" data-v-bb29acb6>${ssrInterpolate(testimonials[1].company)}</p></cite></footer></article><article${ssrRenderAttrs(mergeProps({
        class: "bento-card group",
        "data-delay": "300"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-bb29acb6><div class="card-accent-line card-accent-line--cyan" aria-hidden="true" data-v-bb29acb6></div><span class="quote-mark quote-mark--sm" aria-hidden="true" data-v-bb29acb6>\u201C</span><blockquote class="quote-text" data-v-bb29acb6><p data-v-bb29acb6>${ssrInterpolate(testimonials[2].text)}</p></blockquote><div class="metric-block" data-v-bb29acb6><span class="metric-number metric-number--cyan" data-v-bb29acb6>${ssrInterpolate(testimonials[2].metric)}</span><span class="metric-label" data-v-bb29acb6>${ssrInterpolate(testimonials[2].metricLabel)}</span></div><footer class="author-row" data-v-bb29acb6><div class="author-avatar" style="${ssrRenderStyle({ background: testimonials[2].avatarBg })}" aria-hidden="true" data-v-bb29acb6>${ssrInterpolate(testimonials[2].initials)}</div><cite data-v-bb29acb6><p class="author-name" data-v-bb29acb6>${ssrInterpolate(testimonials[2].name)}</p><p class="author-company" data-v-bb29acb6>${ssrInterpolate(testimonials[2].company)}</p></cite></footer></article></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-bb29acb6"]]);
const _sfc_main$1 = {};
...
//# sourceMappingURL=index-BO0fHGm4.mjs.map
