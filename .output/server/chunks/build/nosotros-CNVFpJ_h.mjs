...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    setMeta({
      ...
      description: "Conoce al equipo de SysifosWeb. Especialistas en desarrollo de software, aplicaciones web y soluciones digitales con a\xF1os de experiencia en Chile. Diego, Karen y Osman - Full Stack Developers.",
      keywords: "equipo desarrollo software, equipo desarrollo web, empresa desarrollo software chile, empresa desarrollo web chile, desarrolladores chile, programadores chile, equipo programaci\xF3n, team desarrollo, agencia digital chile, nosotros sysifosweb, sobre nosotros, quienes somos, equipo tecnolog\xEDa, profesionales desarrollo, expertos desarrollo web, full stack developers chile, scrum chile, metodolog\xEDa \xE1gil, agile development",
...
//# sourceMappingURL=nosotros-CNVFpJ_h.mjs.map
