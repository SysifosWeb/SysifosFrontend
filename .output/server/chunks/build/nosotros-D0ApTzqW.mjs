...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _directive_reveal = resolveDirective("reveal");
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "py-12 md:py-16 relative bg-section-dark overflow-hidden" }, _attrs))} data-v-6673dfcb><div class="ambient-orb ambient-orb--cyan" data-v-6673dfcb></div><div class="relative z-10 w-[90%] max-w-7xl mx-auto flex flex-col gap-20" data-v-6673dfcb><div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-end" data-v-6673dfcb><div class="equipo-header__left" data-v-6673dfcb><p${ssrRenderAttrs(mergeProps({
        class: "overline-label",
        "data-delay": "0"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-6673dfcb>El equipo</p><h2${ssrRenderAttrs(mergeProps({
        class: "equipo-headline",
        "data-delay": "100"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-6673dfcb> Las mentes<br data-v-6673dfcb><em data-v-6673dfcb>detr\xE1s del c\xF3digo.</em></h2></div><div class="equipo-header__right" data-v-6673dfcb><p${ssrRenderAttrs(mergeProps({
        class: "equipo-descriptor",
        "data-delay": "200"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-6673dfcb> Tres especialistas, un est\xE1ndar de ingenier\xEDa. Construimos software que escala, resiste y evoluciona con tu negocio. </p></div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 max-w-5xl mx-auto items-start" data-v-6673dfcb><div${ssrRenderAttrs(mergeProps({
        class: "roster-card group md:mt-14",
        "data-delay": "150"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-6673dfcb><img${ssrRenderAttr("src", unref(karen))} alt="Karen Godoy" class="roster-photo" loading="lazy" data-v-6673dfcb><div class="roster-overlay" data-v-6673dfcb></div><div class="roster-info" data-v-6673dfcb><div class="roster-role" data-v-6673dfcb>`);
      _push(ssrRenderComponent(unref(Database), { class: "roster-role__icon roster-role__icon--purple" }, null, _parent));
      _push(`<span class="roster-role__text roster-role__text--purple" data-v-6673dfcb>DBA &amp; Frontend</span></div><h3 class="roster-name" data-v-6673dfcb>Karen Godoy</h3><p class="roster-bio" data-v-6673dfcb> Control estructural enfocado en optimizaci\xF3n de bases de datos relacionales con eficiencia visual ininterrumpida. </p></div><div class="roster-accent-line roster-accent-line--purple" data-v-6673dfcb></div></div><div${ssrRenderAttrs(mergeProps({
        class: "roster-card group",
        "data-delay": "300"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-6673dfcb><img${ssrRenderAttr("src", unref(osman))} alt="Osman Ahumada" class="roster-photo" loading="lazy" data-v-6673dfcb><div class="roster-overlay" data-v-6673dfcb></div><div class="roster-info" data-v-6673dfcb><div class="roster-role" data-v-6673dfcb>`);
      _push(ssrRenderComponent(unref(Smartphone), { class: "roster-role__icon" }, null, _parent));
      _push(`<span class="roster-role__text" data-v-6673dfcb>Web &amp; Mobile Dev</span></div><h3 class="roster-name" data-v-6673dfcb>Osman Ahumada</h3><p class="roster-bio" data-v-6673dfcb> Especialista arquitect\xF3nico en ecosistemas h\xEDbridos Flutter. Gesti\xF3n fluida en compilaci\xF3n cross-platform. </p></div><div class="roster-accent-line roster-accent-line--cyan" data-v-6673dfcb></div></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-6673dfcb"]]);
const _sfc_main$1 = {
...
//# sourceMappingURL=nosotros-D0ApTzqW.mjs.map
