import { ref, computed, mergeProps, withCtx, createVNode, toDisplayString, openBlock, createBlock, resolveDirective, useSSRContext } from 'vue';
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "py-6 bg-section-dark border-y border-white/5 relative z-10" }, _attrs))} data-v-864a26fb><div class="max-w-[1200px] w-[90%] mx-auto flex flex-col md:flex-row items-center justify-between gap-6" data-v-864a26fb><div class="flex items-center gap-2 overflow-x-auto w-full pb-2 md:pb-0 hide-scrollbar" data-v-864a26fb><!--[-->`);
      ssrRenderList(__props.categories, (category) => {
        _push(`<button class="${ssrRenderClass([__props.modelValue === category.id ? "bg-white text-black" : "text-white/60 hover:text-white hover:bg-white/5", "px-4 py-1.5 text-[0.8rem] font-medium transition-all rounded-full whitespace-nowrap"])}" data-v-864a26fb>${ssrInterpolate(category.name)}</button>`);
      });
      _push(`<!--]--></div><div class="relative w-full md:w-64 flex-shrink-0" data-v-864a26fb><input type="text" placeholder="Buscar art\xEDculos..." class="w-full bg-white/5 border border-white/10 rounded-full px-4 py-2 text-sm text-white placeholder-white/30 focus:outline-none focus:border-white/30 transition-colors" data-v-864a26fb></div></div></section>`);
    };
  }
};
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-864a26fb"]]);
const _sfc_main$2 = {
  __name: "FeaturedPost",
  __ssrInlineRender: true,
  props: {
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "lg:w-1/2 p-8 lg:p-16 flex flex-col justify-center" }, [
                ...
                createVNode("h3", { class: "text-3xl lg:text-5xl font-extrabold text-white mb-6 leading-tight tracking-tight transition-all" }, toDisplayString(__props.post.title), 1),
                createVNode("p", { class: "text-white/60 text-lg leading-relaxed mb-10" }, toDisplayString(__props.post.excerpt), 1),
                createVNode("div", { class: "flex items-center justify-between mt-auto" }, [
                  createVNode("div", { class: "flex items-center gap-3" }, [
                    createVNode("div", { class: "w-10 h-10 rounded-full bg-gradient-to-tr from-sky-400 to-indigo-500 p-[1px]" }, [
                      createVNode("div", { class: "w-full h-full bg-section-dark rounded-full flex items-center justify-center" }, [
                        createVNode("span", { class: "text-xs font-bold text-white" }, "SE")
                      ])
                    ]),
            ...
            if (_push2) {
              ...
              return [
                ...
                createVNode("div", { class: "p-6 lg:p-8 flex flex-col flex-grow" }, [
                  ...
                  createVNode("h3", { class: "text-xl font-bold text-white mb-3 leading-snug group-hover:text-sky-400 transition-colors" }, toDisplayString(post.title), 1),
                  createVNode("p", { class: "text-sm text-white/50 mb-6 flex-grow line-clamp-3 leading-relaxed" }, toDisplayString(post.excerpt), 1),
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    setMeta({
      title: "Blog & Insights | Tecnolog\xEDa y Crecimiento Digital",
      description: "Explora nuestros art\xEDculos sobre arquitectura de software, escalabilidad, dise\xF1o de producto y estrategias tecnol\xF3gicas.",
      keywords: "blog tecnolog\xEDa, desarrollo web chile, arquitectura de software, UX/UI, SEO, performance",
    ...
    const dummyPosts = [
      {
        ...
        excerpt: "El verdadero valor de la ingenier\xEDa de software moderna no est\xE1 en lo que los usuarios ven, sino en las fundaciones invisibles que permiten escalar de 100 a 100,000 usuarios sin fricci\xF3n.",
      ...
      },
      {
        ...
        excerpt: "Por qu\xE9 cada 100ms de latencia te cuesta miles de d\xF3lares en ventas perdidas y c\xF3mo optimizar tu stack tecnol\xF3gico para conversiones.",
      ...
      {
        id: 3,
        title: "Design Systems: M\xE1s all\xE1 de componentes UI",
        excerpt: "C\xF3mo construir un lenguaje visual escalable que conecte dise\xF1o y desarrollo, reduciendo la deuda t\xE9cnica en productos complejos.",
      ...
      {
        id: 5,
        title: "Core Web Vitals: La gu\xEDa definitiva",
        excerpt: "Entiende las m\xE9tricas de Google, c\xF3mo medirlas y las estrategias t\xE9cnicas para obtener un score perfecto.",
      ...
      },
      {
        ...
        excerpt: "Llevando la computaci\xF3n m\xE1s cerca del usuario final para latencias de un solo d\xEDgito y experiencias instant\xE1neas.",
        category: { name: "Performance", slug: "performance" },
        reading_time: "6 min",
        date: "05 Abril 2026",
        author: "Sysifos Engineering",
      ...
      {
        id: 7,
        title: "Micro-frontends: \xBFCu\xE1ndo realmente los necesitas?",
        excerpt: "Desmitificando el hype. Cu\xE1ndo tiene sentido dividir tu capa de presentaci\xF3n y cu\xE1ndo un monolito modular es suficiente.",
        category: { name: "Desarrollo Web", slug: "desarrollo-web" },
        reading_time: "8 min",
        date: "20 Marzo 2026",
...
//# sourceMappingURL=index-DOI2mgQM.mjs.map
