...
import { _ as _sfc_main$5 } from './NuxtImg-Dvqf6ive.mjs';
...
import { _ as __nuxt_component_2$1 } from './CtaSection-CQjChvjE.mjs';
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="text-[0.75rem] font-semibold tracking-wide text-white/90"> Tercer lugar en Desaf\xEDo Genia: Mujeres que Avanzan 2025 </span></div></div></div><div${ssrRenderAttrs(mergeProps({
        ...
        "data-delay": "200"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))}><div class="relative rounded-[20px] overflow-hidden border border-white/5 shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_40px_80px_rgba(0,0,0,0.5)]">`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: unref(team),
        alt: "SysifosWeb \u2014 Arquitecto de nodo",
        class: "w-full h-[480px] object-cover object-center block brightness-[0.88] contrast-[1.04] transition-all duration-[800ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:brightness-[0.96] group-hover:contrast-[1.02] group-hover:scale-[1.02]",
        loading: "lazy",
        format: "webp"
      }, null, _parent));
      _push(`<div class="absolute bottom-0 inset-x-0 pt-10 pb-5 px-6 bg-gradient-to-t from-[#0b1222]/95 to-transparent flex items-center gap-2.5 text-[0.65rem] font-semibold tracking-[0.18em] uppercase text-white/35"><span class="w-[5px] h-[5px] rounded-full bg-accent opacity-70"></span><span>Node Architecture \xB7 v2.4</span></div></div></div></div><div class="grid grid-cols-1 md:grid-cols-3 gap-0 border-t border-white/5"><div${ssrRenderAttrs(mergeProps({
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _directive_reveal = resolveDirective("reveal");
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "py-12 md:py-16 relative bg-section-dark overflow-hidden" }, _attrs))} data-v-9bfab8c4><div class="ambient-orb ambient-orb--cyan" data-v-9bfab8c4></div><div class="relative z-10 w-[90%] max-w-7xl mx-auto flex flex-col gap-20" data-v-9bfab8c4><div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-end" data-v-9bfab8c4><div class="equipo-header__left" data-v-9bfab8c4><p${ssrRenderAttrs(mergeProps({
        class: "overline-label",
        "data-delay": "0"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-9bfab8c4>El equipo</p><h2${ssrRenderAttrs(mergeProps({
        class: "equipo-headline",
        "data-delay": "100"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-9bfab8c4> Las mentes<br data-v-9bfab8c4><em data-v-9bfab8c4>detr\xE1s del c\xF3digo.</em></h2></div><div class="equipo-header__right" data-v-9bfab8c4><p${ssrRenderAttrs(mergeProps({
        class: "equipo-descriptor",
        "data-delay": "200"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-9bfab8c4> Tres especialistas, un est\xE1ndar de ingenier\xEDa. Construimos software que escala, resiste y evoluciona con tu negocio. </p></div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 max-w-5xl mx-auto items-start" data-v-9bfab8c4><div${ssrRenderAttrs(mergeProps({
        class: "roster-card group md:mt-14",
        "data-delay": "150"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-9bfab8c4><img${ssrRenderAttr("src", unref(karen))} alt="Karen Godoy" class="roster-photo" loading="lazy" data-v-9bfab8c4><div class="roster-overlay" data-v-9bfab8c4></div><div class="roster-info" data-v-9bfab8c4><div class="roster-role" data-v-9bfab8c4>`);
      _push(ssrRenderComponent(unref(Database), { class: "roster-role__icon roster-role__icon--purple" }, null, _parent));
      _push(`<span class="roster-role__text roster-role__text--purple" data-v-9bfab8c4>DBA &amp; Frontend</span></div><h3 class="roster-name" data-v-9bfab8c4>Karen Godoy</h3><p class="roster-bio" data-v-9bfab8c4> Control estructural enfocado en optimizaci\xF3n de bases de datos relacionales con eficiencia visual ininterrumpida. </p></div><div class="roster-accent-line roster-accent-line--purple" data-v-9bfab8c4></div></div><div${ssrRenderAttrs(mergeProps({
        class: "roster-card group",
        "data-delay": "300"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-9bfab8c4><img${ssrRenderAttr("src", unref(osman))} alt="Osman Ahumada" class="roster-photo" loading="lazy" data-v-9bfab8c4><div class="roster-overlay" data-v-9bfab8c4></div><div class="roster-info" data-v-9bfab8c4><div class="roster-role" data-v-9bfab8c4>`);
      _push(ssrRenderComponent(unref(Smartphone), { class: "roster-role__icon" }, null, _parent));
      _push(`<span class="roster-role__text" data-v-9bfab8c4>Web &amp; Mobile Dev</span></div><h3 class="roster-name" data-v-9bfab8c4>Osman Ahumada</h3><p class="roster-bio" data-v-9bfab8c4> Especialista arquitect\xF3nico en ecosistemas h\xEDbridos Flutter. Gesti\xF3n fluida en compilaci\xF3n cross-platform. </p></div><div class="roster-accent-line roster-accent-line--cyan" data-v-9bfab8c4></div></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-9bfab8c4"]]);
const _sfc_main$1 = {
...
//# sourceMappingURL=nosotros-CF6BZA7p.mjs.map
